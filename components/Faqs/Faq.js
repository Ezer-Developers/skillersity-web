            ...
            <div className="col-lg-12">
              <div className="rbt-accordion-style accordion">
                <div className="section-title text-start mb--60">
                  <h4 className="title">Frequently Asked Questions (FAQs)</h4>
                </div>
                <div className="rbt-accordion-style rbt-accordion-04 accordion">
                  ...
                  <p>For any further queries, feel free to reach out to our support team at <a href="mailto:Info@skillersity.com">Info@skillersity.com</a></p>
                </div>
              </div>
            </div>
