...
import client2 from "../../public/images/testimonial/client-05.jpeg";
import client3 from "../../public/images/testimonial/client-06.png";
import client4 from "../../public/images/testimonial/client-04.png";
...
const LanguageAcademy = ({ blogs }) => {
  ...
  return (
    <>
                  ...
                  <div className="inner">
                    <div className="section-title text-start">
                      <span className="subtitle bg-primary-opacity">
                        Welcome to SKILLERSITY
                      </span>
                    </div>
                    <h1 className="title">
                      Advancing
                      <span className="theme-gradient"> Your Career with</span> Practical Learning
                    </h1>
                    <h5> Digital Marketing | Graphic Design | Video Editing</h5>
                    ...
                    <div className="rbt-button-group justify-content-start mt--30">
                      <Link
                        className="rbt-btn btn-gradient rbt-marquee-btn rbt-switch-btn"
                        href="/courses"
                      >
      ...
      <div className="rbt-about-area bg-color-white pb_md--80 pb_sm--80 about-style-1" style={{ paddingTop: "40px",paddingBottom: "40px" }}>
          <div className="container">
            <SplitTwo />
          </div>
      </div>
          ...
          <div className="row align-items-center mb--60">
            <div className="col-lg-12">
              <div className="section-title text-center">
                ...
                <p className="description has-large-font-size mt--20">
                  Turn Your Ambitions into Reality with
                </p>
                <h2 className="title">SKILLERSITY Academy.</h2><br></br>
              </div>
            </div>
          </div>
          <div className="row g-5">
                ...
                >
                  <div className={`rbt-card variation-03 rbt-hover`}>
                    ...
                    <div className="card-information">
                      ...
                      <div className="card-count">{data.days} Weeks</div>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="row mb--60">
            <div className="col-lg-12">
              <div className="section-title text-center">
                ...
                <h2 className="title">Why Choose SKILLERSITY Academy</h2>
      ...
      <div
        ...
        data-black-overlay="5" style={{ backgroundImage: `url(/images/bg/backgroud_1111.jpeg)` }}
      >
        <div className="container">
          <CountDownTwo />
        </div>
      ...
      <div className="rbt-rbt-blog-area rbt-section-gap bg-gradient-1">
        <div className="container">
          <div className="row mb--55 row--30 align-items-end">
            <div className="col-lg-12">
              <div className="section-title text-center">
                <span className="subtitle bg-pink-opacity">Our Blogs</span>
