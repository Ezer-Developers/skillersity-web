...
const Maintenance = () => {
  return (
    <div
      className="rbt-countdown-area rbt-maintenance-area bg_image--6 bg_image--6 bg_image_fixed rbt-section-gap vh-100 d-flex align-items-center justify-content-center"
